...
"""
    ...
    steps {
        ...
        cd ansible && docker run --rm -v C:\ProgramData\Jenkins\.jenkins\workspace\terraform:/workspace -w /workspace/ansible ansible-runner ansible-playbook -i ../inventory.ini --private-key=/ssh_key.pem deploy_gamestore.yml            
        }
    }
}
